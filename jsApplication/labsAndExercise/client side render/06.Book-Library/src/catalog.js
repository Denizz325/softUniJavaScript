import { deleteBooks, getBooks, html, until } from "./utility.js";

const catalogTemplate = (booksPromis) => html` <table>
  <thead>
    <tr>
      <th>Title</th>
      <th>Author</th>
  ...
  <tbody>
    ${until(booksPromis,html`<tr><td colspan="3">Loading&hellip;</td></tr>`
    )}
  </tbody>
</table>`;
